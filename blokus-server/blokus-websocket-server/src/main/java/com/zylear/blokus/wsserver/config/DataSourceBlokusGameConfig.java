...
import com.zylear.blokus.wsserver.util.MybatisDataSourceConfigHelper;
...
public class DataSourceBlokusGameConfig {
    ...
    public final static String SCAN_PACKAGE = "com.zylear.blokus.wsserver.dao.mybatis.blokusgame";
    ...
    public final static List<String> XML_PATHS = Arrays.asList("classpath:com/zylear/blokus/wsserver/dao/mybatis/blokusgame/*.xml");
